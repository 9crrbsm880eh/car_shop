...
MIDDLEWARE = [
    ...
    'mainapp.middleware.NotFoundMiddleware',
...
DATABASES = {
    ...
    'default': dj_database_url.config(
        default='postgres://car_shop_3f1h_user:1gNDoStiLqykvaDEnU07QCxJfRuJsnkr@dpg-cpg6l5gl5elc738oikcg-a.oregon-postgres.render.com/car_shop_3f1h',
        conn_max_age=600,
        ssl_require=True
    )
}
